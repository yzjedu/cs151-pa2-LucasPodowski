...
- Although this algorithm meets the requirements, there is no need to use functions at this point in time. The algorithm can be done without using any function. 
- 
### Grade: M